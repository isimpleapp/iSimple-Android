...
public class CatalogByCategoryActivity extends BaseExpandableListActivity implements LoaderManager.LoaderCallbacks<Cursor>, SearchView.OnQueryTextListener, ExpandableListView.OnChildClickListener {
...
//        mSearchView = (SearchView) menu.findItem(R.id.menu_search).getActionView();
    ...
    private void initFilter() {
        ...
        switch (drinkCategory) {
            case WINE:
                header = getLayoutInflater().inflate(R.layout.wine_filter_fragment, null);
                initWineFilter();
                break;
            case SPIRITS:
                header = getLayoutInflater().inflate(R.layout.spirits_filter_fragment, null);
                initSpiritsFilter();
                break;
            case SPARKLING:
                header = getLayoutInflater().inflate(R.layout.sparkilng_filter_fragment, null);
                initSparklingFilter();
                break;
            case SAKE:
                header = getLayoutInflater().inflate(R.layout.sake_filter_fragment, null);
                initSakeFilter();
                break;
            case PORTO:
                header = getLayoutInflater().inflate(R.layout.porto_heres_filter_fragment, null);
                initPortoHeresFilter(header);
                break;
            case WATER:
                header = getLayoutInflater().inflate(R.layout.water_filter_fragment, null);
