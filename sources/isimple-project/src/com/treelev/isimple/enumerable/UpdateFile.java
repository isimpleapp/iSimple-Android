...
public enum UpdateFile {
	...
	CATALOG_UPDATES("CatalogUpdates"), ITEM_PRICES("ItemPrices"), ITEM_AVAILABILITY("ItemAvailability"), LOCATIONS_AND_CHAINS_UPDATES(
			"LocationsAndChainsUpdates"), DELIVERY("Delivery"), FEATURED("Featured"), DISCOUNT("Discount"), DEPRECATED("Deprecated");
