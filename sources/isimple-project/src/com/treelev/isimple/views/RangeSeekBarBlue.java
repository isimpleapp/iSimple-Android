...
public class RangeSeekBarBlue<T extends Number> extends ImageView {
    ...
    private final Bitmap thumbPressedImage = BitmapFactory.decodeResource(getResources(), R.drawable.scrubber_control_pressed_holo);
    ...
    /**
     * Default color of a {@link RangeSeekBarBlue}, #FF33B5E5. This is also known as "Ice Cream Sandwich" blue.
     */
    //public static final int DEFAULT_COLOR = Color.argb(0xFF, 0x33, 0xB5, 0xE5);
    public static final int DEFAULT_COLOR = Color.parseColor("#4bbbeb");
     ...
     */
    public RangeSeekBarBlue(T absoluteMinValue, T absoluteMaxValue, Context context) throws IllegalArgumentException {
        super(context);
...
//        return Math.abs(touchX - normalizedToScreen(normalizedThumbValue)) <= thumbHalfWidth;
        return Math.abs(touchX - normalizedToScreen(normalizedThumbValue)) <= 1.5*thumbWidth;
    }
    ...
    private T normalizedToValue(double normalized) {
        ...
        return (T)  numberType.toNumber(value < absoluteMinValuePrim ? value + absoluteMinValuePrim : value);
//        return (T)  numberType.toNumber( absoluteMinValuePrim + normalized * (absoluteMaxValuePrim - absoluteMinValuePrim));
    }

    private T normalizedToMinValue(double normalized) {
        double value = Math.pow(normalized, 4.0) * absoluteMaxValuePrim;
        return (T)  numberType.toNumber(value + absoluteMinValuePrim);
//        return (T)  numberType.toNumber( absoluteMinValuePrim + normalized * (absoluteMaxValuePrim - absoluteMinValuePrim));
    }
...
//        return (value.doubleValue() - absoluteMinValuePrim) / (absoluteMaxValuePrim - absoluteMinValuePrim);
        return Math.pow((value.doubleValue() - absoluteMinValuePrim) / (absoluteMaxValuePrim - absoluteMinValuePrim), 0.25 );
    }
    ...
    public interface OnRangeSeekBarChangeListener<T> {
        public void onRangeSeekBarValuesChanged(RangeSeekBarBlue<?> bar, T minValue, T maxValue);
    }
